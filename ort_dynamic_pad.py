...
model_path_1 = './logs/models/dynamic/done/' + model +'_decoder_1_prefill_ex_v21_INT4_QDQ_final.onnx'
# model_path_2 = './logs/models/dynamic/done/' + model +'_decoder_2_decode_ex_v21_INT4_QDQ.onnx'
model_path_2 = './logs/models/dynamic/done/' + model +'_decoder_1_prefill_ex_v21_INT4_QDQ_final.onnx'
