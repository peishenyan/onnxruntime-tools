...
model_fp32_path_1 = 'logs/models/'+ model + '/' + model +'_decoder_static_non_kvcache_lm_ex.onnx'
...
model_fp32_path_2 = 'logs/models/'+ model + '/' + model +'_decoder_static_kvcache_128_lm_ex.onnx'
