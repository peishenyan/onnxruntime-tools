...
model_path_1 = './logs/models/ori/'+ model + '/done/' + model + '_decoder_1_prefill_ex_v21_INT4_QDQ.onnx'
model_path_2 = './logs/models/ori/'+ model + '/done/' + model + '_decoder_2_decode_ex_v21_INT4_QDQ.onnx'
...
input_ids = input_data.input_ids.numpy().astype(np.int64)
